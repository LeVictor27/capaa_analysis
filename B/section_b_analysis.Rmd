...
model_fed_nocpi <- lm(rev_pp_cwi ~ log(TotalEnrollment) + LOCALE + PctSpecialEducation + PctTransitionalBilingual,
             data=df_f195_fed)
...
model_state_nocpi <- lm(rev_pp_cwi ~ log(TotalEnrollment) + LOCALE + PctSpecialEducation + PctTransitionalBilingual,
             data=df_f195_state)
...
model_loc_nocpi <- lm(rev_pp_cwi ~ log(TotalEnrollment) + LOCALE + PctSpecialEducation + PctTransitionalBilingual,
             data=df_f195_loc)
...
ggplot(df_f195_fed_figure_pov_saipe, 
       aes(x=schyear, y=rev_adjusted_nocpi, fill=deciles_5to17)) + 
  stat_summary(geom="line", fun="mean", alpha=0.5) +
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_5to17), alpha=0.25) +
  labs(title="Figure. Federal Revenue Amount Per Student (SAIPE) (NO CPI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
...
ggplot(df_f195_fed_figure_pov_frpl, 
       aes(x=schyear, y=rev_adjusted_nocpi, fill=deciles_frpl)) + 
  stat_summary(geom="line", fun="mean", alpha=0.5) +
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_frpl), alpha=0.25) +
  labs(title="Figure. Federal Revenue Amount Per Student (FRPL) (NO CPI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
ggplot(df_f195_state_figure_pov, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_5to17), alpha=0.25) +
  labs(title="Figure. State Revenue Amount Per Student (SAIPE) (NO CPI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
ggplot(df_f195_state_figure_pov_frpl, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_frpl), alpha=0.25) +
  labs(title="Figure. State Revenue Amount Per Student (FRPL) (NO CPI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
ggplot(df_f195_loc_figure_pov, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_5to17), alpha=0.25) +
  labs(title="Figure. Local Revenue Amount Per Student (SAIPE) (NO CPI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
ggplot(df_f195_loc_figure_pov, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_frpl), alpha=0.25) +
  labs(title="Figure. Local Revenue Amount Per Student (FRPL) (NO CPI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
ggplot(df_f195_total_figure_pov, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_5to17), alpha=0.25) +
  labs(title="Figure. Total Revenue Amount Per Student (SAIPE) (NO CPI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
ggplot(df_f195_total_figure_pov, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_frpl), alpha=0.25) +
  labs(title="Figure. Total Revenue Amount Per Student (FRPL) (NO CPI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
wa_df196 %>%
  ...
  theme_void() +
  labs(title="Figure. Regionalization Factor, 2019")+
  theme(plot.title = element_text(hjust = 0.5))
