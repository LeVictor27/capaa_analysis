...
model_fed_nocwi <- lm(rev_pp_cwi ~ log(TotalEnrollment) + LOCALE + PctSpecialEducation + PctTransitionalBilingual,
             data=df_f195_fed)
...
model_state_nocwi <- lm(rev_pp_cwi ~ log(TotalEnrollment) + LOCALE + PctSpecialEducation + PctTransitionalBilingual,
             data=df_f195_state)
...
model_loc_nocwi <- lm(rev_pp_cwi ~ log(TotalEnrollment) + LOCALE + PctSpecialEducation + PctTransitionalBilingual,
             data=df_f195_loc)
...
df_f195_total <- df_f195_total%>%
  ...
  rename(schyear=df_f195_fed.schyear,
...
## Revenue Category Over Time

```{r B1_revenue_pov_plots}
df_f195_fed_figure_pov <- df_f195_fed%>%
  filter(deciles_5to17==1 | deciles_5to17 == 9)%>%
  mutate(deciles_5to17 = as.factor(deciles_5to17))
  
levels(df_f195_fed_figure_pov$deciles_5to17) <- c("Low-Poverty", "High-Poverty")

ggplot(df_f195_fed_figure_pov, 
...
ggplot(df_f195_fed_figure_pov, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_5to17), alpha=0.25) +
  labs(title="Figure. Federal Revenue Amount Per Student (NO CWI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
...
ggplot(df_f195_state_figure_pov, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_5to17), alpha=0.25) +
  labs(title="Figure. State Revenue Amount Per Student (NO CWI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
ggplot(df_f195_loc_figure_pov, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_5to17), alpha=0.25) +
  labs(title="Figure. Local Revenue Amount Per Student (NO CWI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
ggplot(df_f195_total_figure_pov, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_5to17), alpha=0.25) +
  labs(title="Figure. Total Revenue Amount Per Student",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, average cost of labor, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
ggplot(df_f195_total_figure_pov, 
  ...
  stat_summary(geom="ribbon", 
               fun.data = mean_se, #mean_cl_normal
               aes(fill=deciles_5to17), alpha=0.25) +
  labs(title="Figure. Total Revenue Amount Per Student (NO CWI)",
       subtitle = "Regression adjusted for difference of cost factors including district size, 
       urbanicity/locale, and percent of students enrolled in 
       special education and classified as limited English proficient",
       caption="Note: High and low-poverty districts estimated at the 10th and 90th percentile 
...
df_f195_all_merge_avg%>%
  ...
  labs(title="Figure. Average Per-Student Dollar Amount by All Revenue Categories, 2019-2020")+
