...
model_fed <- lm(rev_pp_18d ~ log(TotalEnrollment) + LOCALE + PctSpecialEducation + PctTransitionalBilingual  + PctFreeorReducedPricedMeals + (PctFreeorReducedPricedMeals*schyear), data=df_rev_fed) 
...
#DIRECTIONS
#Do interaction pctfreereductedpricemeals 
#Pull out the year and run the model for each year
#Get the coefficient for FRPL and model the coefficient afterward
#Get a marginal effect for 25%, 50% and 75% for FRPL 
...
#marginal effect, one percentage change yields x amount of change, 25% and 75% level. After accounting for 25% percentile, this is how the predicted dollar amount


df_rev_fed$rev_adjusted <- predict.lm(model_fed, newdata=df_rev_fed)
#Worry that the Error term leaves a lot, lots of noise left in the error term, it'll be hard to interpret the predict effect/reg adjusted way
...
model_state <- lm(rev_pp_18d ~ log(TotalEnrollment) + LOCALE + PctSpecialEducation + PctTransitionalBilingual + PctFreeorReducedPricedMeals + schyear + (PctFreeorReducedPricedMeals*schyear), data=df_rev_state)
...
state_adj_plot <- state_adj_plot%>%
  tibble::add_row(frpl_group=1,
                  ...
                  adj_2016=mean(state_margins_frpl_25$rev_pp_18d[state_margins_frpl_25$schyear==2016], na.rm=TRUE) +
                    mean(state_margins_frpl_25$dydx_schyear2016, na.rm = TRUE),
                  adj_2017=mean(state_margins_frpl_25$rev_pp_18d[state_margins_frpl_25$schyear==2017], na.rm=TRUE) +
                    mean(state_margins_frpl_25$dydx_schyear2017, na.rm = TRUE),
                  adj_2018=mean(state_margins_frpl_25$rev_pp_18d[state_margins_frpl_25$schyear==2018], na.rm=TRUE) +
                    mean(state_margins_frpl_25$dydx_schyear2018, na.rm = TRUE),
                  adj_2019=mean(state_margins_frpl_25$rev_pp_18d[state_margins_frpl_25$schyear==2019], na.rm=TRUE) +
                    mean(state_margins_frpl_25$dydx_schyear2019, na.rm = TRUE),
                  adj_2020=mean(state_margins_frpl_25$rev_pp_18d[state_margins_frpl_25$schyear==2020], na.rm=TRUE) +
                    mean(state_margins_frpl_25$dydx_schyear2020, na.rm = TRUE),
                  adj_2021=mean(state_margins_frpl_25$rev_pp_18d[state_margins_frpl_25$schyear==2021], na.rm=TRUE) +
  ...
  tibble::add_row(frpl_group=2,
                  ...
                  adj_2016=mean(state_margins_frpl_50$rev_pp_18d[state_margins_frpl_50$schyear==2016], na.rm=TRUE) +
                    mean(state_margins_frpl_50$dydx_schyear2016, na.rm = TRUE),
                  adj_2017=mean(state_margins_frpl_50$rev_pp_18d[state_margins_frpl_50$schyear==2017], na.rm=TRUE) +
                    mean(state_margins_frpl_50$dydx_schyear2017, na.rm = TRUE),
                  adj_2018=mean(state_margins_frpl_50$rev_pp_18d[state_margins_frpl_50$schyear==2018], na.rm=TRUE) +
                    mean(state_margins_frpl_50$dydx_schyear2018, na.rm = TRUE),
                  adj_2019=mean(state_margins_frpl_50$rev_pp_18d[state_margins_frpl_50$schyear==2019], na.rm=TRUE) +
                    mean(state_margins_frpl_50$dydx_schyear2019, na.rm = TRUE),
                  adj_2020=mean(state_margins_frpl_50$rev_pp_18d[state_margins_frpl_50$schyear==2020], na.rm=TRUE) +
                    mean(state_margins_frpl_50$dydx_schyear2020, na.rm = TRUE),
                  adj_2021=mean(state_margins_frpl_50$rev_pp_18d[state_margins_frpl_50$schyear==2021], na.rm=TRUE) +
  ...
  tibble::add_row(frpl_group=3,
                  ...
                  adj_2016=mean(state_margins_frpl_75$rev_pp_18d[state_margins_frpl_75$schyear==2016], na.rm=TRUE) +
                    mean(state_margins_frpl_75$dydx_schyear2016, na.rm = TRUE),
                  adj_2017=mean(state_margins_frpl_75$rev_pp_18d[state_margins_frpl_75$schyear==2017], na.rm=TRUE) +
                    mean(state_margins_frpl_75$dydx_schyear2017, na.rm = TRUE),
                  adj_2018=mean(state_margins_frpl_75$rev_pp_18d[state_margins_frpl_75$schyear==2018], na.rm=TRUE) +
                    mean(state_margins_frpl_75$dydx_schyear2018, na.rm = TRUE),
                  adj_2019=mean(state_margins_frpl_75$rev_pp_18d[state_margins_frpl_75$schyear==2019], na.rm=TRUE) +
                    mean(state_margins_frpl_75$dydx_schyear2019, na.rm = TRUE),
                  adj_2020=mean(state_margins_frpl_75$rev_pp_18d[state_margins_frpl_75$schyear==2020], na.rm=TRUE) +
                    mean(state_margins_frpl_75$dydx_schyear2020, na.rm = TRUE),
                  adj_2021=mean(state_margins_frpl_75$rev_pp_18d[state_margins_frpl_75$schyear==2021], na.rm=TRUE) +
  ...
  tibble::add_row(frpl_group=4,
                  ...
                  adj_2016=mean(state_margins_frpl_100$rev_pp_18d[state_margins_frpl_100$schyear==2016], na.rm=TRUE) +
                    mean(state_margins_frpl_100$dydx_schyear2016, na.rm = TRUE),
                  adj_2017=mean(state_margins_frpl_100$rev_pp_18d[state_margins_frpl_100$schyear==2017], na.rm=TRUE) +
                    mean(state_margins_frpl_100$dydx_schyear2017, na.rm = TRUE),
                  adj_2018=mean(state_margins_frpl_100$rev_pp_18d[state_margins_frpl_100$schyear==2018], na.rm=TRUE) +
                    mean(state_margins_frpl_100$dydx_schyear2018, na.rm = TRUE),
                  adj_2019=mean(state_margins_frpl_100$rev_pp_18d[state_margins_frpl_100$schyear==2019], na.rm=TRUE) +
                    mean(state_margins_frpl_100$dydx_schyear2019, na.rm = TRUE),
                  adj_2020=mean(state_margins_frpl_100$rev_pp_18d[state_margins_frpl_100$schyear==2020], na.rm=TRUE) +
                    mean(state_margins_frpl_100$dydx_schyear2020, na.rm = TRUE),
                  adj_2021=mean(state_margins_frpl_100$rev_pp_18d[state_margins_frpl_100$schyear==2021], na.rm=TRUE) +
...
ggplot(state_adj_plot_long, 
  ...
  geom_point()+
  geom_line()+
  labs(title="State Adjusted Revenue (PP 2018 + AME)")
...
ggplot(local_adj_plot_long, 
  ...
  geom_point()+
  geom_line()+
  labs(title="Local Adjusted Revenue (PP 2018 + AME)")
...
ggplot(statelocal_adj_long, 
  ...
  geom_point()+
  geom_line()+
  labs(title="State + Local Adjusted Revenue (PP 2018 + AME)")
...
*NEED TO LOOK AT DATA SOURCE, CURRENTLY NOT SYNCED WITH UPDATED DATA*
