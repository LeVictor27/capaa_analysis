...
* Notes
  + no income indicator for course taking
...
> A.1.1 Student Enrollment Count for Kindergardeners 6th and 9th Graders

```{r Student Enrollment Count for All Grade Levels}
...
```{r A.1.i Student Enrollment Count for Kindergardeners, include=FALSE}
...
```{r A.1.1 Student Enrollment Count for Kindergardeners 6th and 9th Graders}
...
> A.1.2 Student Enrollment Percentagee for Kindergardeners 6th and 9th Graders
...
```{r A.1.iv Student Enrollment Percentage for Kindergardeners, include=FALSE}
...
```{r A.1.2 Student Enrollment Percentagee for Kindergardeners 6th and 9th Graders}

```


> A.1.3. Student Enrollment Change for Kindergardeners 6th and 9th Graders

Change from SY 2019-20 to SY 2020-21; NO SY 2018-29 ENROLL COUNTS DATA AT GRADE LEVEL

```{r Student Enrollment Change for Kindergardener sorted by races, include=FALSE}
...
```{r Student Enrollment Change for Kindergardener sorted by income, include=FALSE}
...
```{r A.1.3.i Student Enrollment Change for Kindergardeners 6th and 9th Graders sorted by races}
...
```{r A.1.3.ii Student Enrollment Change for Kindergardeners 6th and 9th Graders sorted by income}
...
Grade K, 3rd, 6th, 8th, 9th, 10th grade.
...
```{r A.3.1. Statewide breakdown by groups}
