...
* for total absences
  + higher grade levels have have high absences
...
* for difference in absences between sy2018-19 and sy2020-21
  + difference = absences in sy2018-19 (of particular student group in a certain month) - absences in sy2020-21 (of the same student group in that month)
  + negative value means that absences in sy2020-21 is higher
...
```{r A.2.1.i Student Absence Count sorted by races, warning=FALSE}
...
```{r A.2.1.i Student Absence Count sorted by races unstacked, warning=FALSE}
...
```{r A.2.1.ii Student Absence Count sorted by income unstacked}
...
absences_change <- df_absences %>%
  filter(StudentGroup == "All Students" | 
           ...
           StudentGroup == "Two or More Races"|
           StudentGroup == "White") %>%
  mutate(October = as.numeric(`10/2019`) - as.numeric(`10/2021`),
         November = as.numeric(`11/2019`) - as.numeric(`11/2021`),
         December = as.numeric(`12/2019`) - as.numeric(`12/2021`),
         January = as.numeric(`01/2019`) - as.numeric(`01/2021`),
         February = as.numeric(`02/2019`) - as.numeric(`02/2021`)) %>%
...
```{r A.2.2.i Student Absence Change sorted by races, warning=FALSE}
...
#  geom_bar(stat="identity", width = 0.4) +
  ...
  ggtitle("Difference in Total Absences",
          subtitle = "between School Year 2018-19 amd School Year 2020-21") +
        labs(x = "Student Groups", 
...
```{r A.2.2.ii Student Absence Change sorted by income, warning=FALSE}
...
* for Percentage of All Courses Taken Resulted in Non-Passing Grade
  ...
  + gaps between those groups and the others increased from sy2018-19 to sy-2020-21
...
```{r A.3.2.1.i The Difference in all non-passing grade from 2018-19 to 2020-21 (white vs nonwhite), echo=FALSE, message=FALSE, warning=FALSE}
...
```{r A.3.2.1.ii The Difference in all non-passing grade from 2018-19 to 2020-21 (low-income vs non-low income)}
