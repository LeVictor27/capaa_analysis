...
plot_enroll_count <- long_enroll_by_races %>%
  ...
  ggplot(aes(fill = Month, x = StudentGroup, y = EnrollmentCounts)) + 
...
### found shapefiles (https://geo.wa.gov/datasets/k12wa::washington-school-district-boundaries/about) and uploaaded to googledrive 10/26
## plot II: spatial; 
