...
long_change_enroll_race_grades %>%
  ...
  ggtitle("Percentage Change in Student Enrollment",
           subtitle = "between 2020 and 2021") +
  labs(x = "Student Groups", 
...
```{r A.2.2.iii Student Absence PERCENTAGE Change sorted by races, eval=FALSE, fig.height=14, fig.width=10, include=FALSE}
...
```{r A.2.2.iii Student Absence PERCENTAGE Change sorted by income, eval=FALSE, fig.height=12, fig.width=10, include=FALSE}
...
course_by_race %>%
  ...
  labs(x = "Student Groups", 
       ...
       non-passing grade has increased between 2019 and 2021 for the given student group") +
...
wa_nonpass_white %>% 
  ...
  labs(title="Change in Percent of All Courses Taken Resulted in No Credit",
       subtitle = "for white students between 2019 and 2021",
       caption = "Note: grey areas indicate districts with unavaible or suppressed data
       A positive value means that the percent of all courses taken resulted in 
       non-passing grade has increased between 2019 and 2021 for the given student group")
...
wa_nonpass_nonwhite %>% 
  ...
  theme_void() +
  labs(title="Change in Percent of All Courses Taken Resulted in No Credit",
       subtitle = "for students of color between 2019 and 2021",
       caption = "Note: grey areas indicate districts with unavaible or suppressed data
       A positive value means that the percent of all courses taken resulted in 
       non-passing grade has increased between 2019 and 2021 for the given student group")
...
wa_numfail_white %>% 
  ...
  labs(title="Change in Percent of All Courses Taken Resulted in Numerical Failing Grade",
       subtitle = "for white students between 2019 and 2021",
       caption = "Note: grey areas indicate districts with unavaible or suppressed data
       A positive value means that the percent of all courses taken resulted in numerical
       failing grade has increased between 2019 and 2021 for the given student group")
...
wa_nonpass_low %>% 
  ...
  theme_void() +
  labs(title="Change in Percent of All Courses Taken Resulted in No Credit",
       subtitle = "for low-income student group between 2019 and 2021",
...
wa_nonpass_nonlow %>% 
  ...
  theme_void() +
  labs(title="Change in Percent of All Courses Taken Resulted in No Credit",
       subtitle = "for non-low income student group between 2019 and 2021",
       caption = "Note: grey areas indicate districts with unavaible data
       A positive value means that the percent of all courses taken resulted in
       non-passing grade has increased between 2019 and 2021 for the given student group")
...
wa_nonpass_race_gap %>% 
  ...
  labs(title="Gap in All Courses Taken Resulted in No Credit",
       subtitle = "between students of color and white students in 2021",
       caption = "Note: grey areas indicate districts with unavaible or suppressed data")
...
wa_nonpass_gap %>% 
  ...
  theme_void() +
  labs(title="Gap in All Courses Taken Resulted in No Credit",
       subtitle = "between low-income student group and non-low income student group in 2021",
       caption = "Note: grey areas indicate districts with unavaible or suppressed data")
...
state_ontrack_race_change %>%
  ...
  ggtitle("Change in Percentage of 9th Grade Students on Track",
          subtitle = "between 2018 and 2020") +
  labs(x = "Student Groups",
       y = "Change in Percentage",
...
state_regatt_race_change %>%
  ...
  ggtitle("Change in Percentage of Regular Attendance",
          subtitle = "between 2018 and 2020 for all grades") +
  labs(x = "Student Groups",
       y = "Change in Percentage",
       caption = "A negative value means that the percentage of 9th grade students on track 
       has decreased between 2018 and 2020 for the given student group") +
