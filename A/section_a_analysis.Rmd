...
* Notes 11/17
  + A.1, A.2,and A.3 are completed
  + next: working on pathway and graduation
  + A.3 check for missing district-level data for students of color
  + A.3 match district names in OSPI files and shape files

* Notes after 11/10 meeting
  + In term of change, positive values indicate increase in SY2020-21 and negative values indicate decrease in SY2020-21 for all the plots in this file. 
