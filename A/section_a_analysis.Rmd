...
```{r **A.3.1.iv Statewide breakdown by income num nonpass, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r **A.3.2.1.vi The Difference in num pass from 2018-19 to 2020-21 white, message=FALSE, warning=FALSE}
...
test <- df_course_outcomes_by_outcome %>%
 filter(`Organization Name` == "Washington State") %>%
 select(c("School Year", "Student Group", "Grade Level", "Numerical Failing Grades", "Numerical Passing Grades"))
```
