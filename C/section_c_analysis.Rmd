...
df_s275 %>% 
  ...
  labs(title = "Scatterplot of (unadjusted) teacher salary and regionalization factor \nfor school districts during AY 2018-2019")
...
df_s275 %>% 
  ...
  theme_classic() +
  theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank()) +
  labs(title = "Scatterplot of (adjusted) teacher salary and regionalization factor \nfor school districts during AY 2018-2019",
...
df_s275 %>% 
  ...
  labs(x = "Share of students receiving FRPL",
       title = "Scatterplot of (unadjusted) teacher salary and share of FRPL \nfor school districts during AY 2018-2019")
...
df_s275 %>% 
  ...
  theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank()) +
  labs(x = "Share of students receiving FRPL",
       title = "Scatterplot of (adjusted) teacher salary and share of FRPL \nfor school districts during AY 2018-2019",
       subtitle = "normalized by cost of wage index for each school district")
...
df_s275 %>% 
  ...
  labs(x = "Share of non-white students (excludes asian)",
       title = "Scatterplot of (unadjusted) teacher salary and share of students of color \nfor school districts during AY 2018-2019")
...
df_s275 %>% 
  ...
  labs(x = "Share of non-white students (exclude asian)",
       title = "Scatterplot of (adjusted) teacher salary and share of students of color \nfor school districts during AY 2018-2019",
       subtitle = "normalized by cost of wage index for each school district")
```
...
df_s275_dist <- df_s275 %>% 
  ...
  summarize(mean_dist_tch_black = mean(race == "B", na.rm = TRUE),
            ...
            mean_dist_tch_white = mean(race == "W", na.rm = TRUE),
            mean_dist_tch_nonwhite = mean(race != "W" & race != "A", na.rm = TRUE),
            
            dist_pctstu_black = mean(replace_na(dis_pctstu_black, 0)),
            dist_pctstu_asian = mean(replace_na(dis_pctstu_asian, 0)),
            dist_pctstu_hispanic = mean(replace_na(dis_pctstu_hispanic, 0)),
            dist_pctstu_white = mean(replace_na(dis_pctstu_white, 0)),
            dist_pctstu_nonwhite = mean(1 - replace_na(dis_pctstu_white, 0) - replace_na(dis_pctstu_asian, 0)),
...
df_s275_dist %>% 
  ...
  labs(x = "Share of students of color",
       ...
       title = "Scatterplot of share of nonwhite teachers and students of color across WA school districts in AY 2018-2019",
...
df_s275_dist %>% 
  ...
  labs(x = "Share of students receiving FRPL",
       y = "Share of non-white teachers",
       title = "Scatterplot of share of nonwhite teachers and students poverty (measured by FRPL) across WA school districts in AY 2018-2019",
       caption = "In all estimates, asians are excluded from non-white or people of color categories.")
...
df_s275_dist %>%
  ...
  labs(x =  "Share of non-white teachers",
       ...
       title = "Density of non-white teachers across WA school districts in AY 2018-2019 by low to high shares of students poverty (measured by FRPL)",
       caption = "In all estimates, asians are excluded from non-white or people of color categories.")
...
df_s275_dist %>%
  ...
  labs(x =  "Share of students of color in a district",
       ...
       title = "Scatterplot of share of teachers with highest degree as bachelor's and share of students of color across WA school districts\nin AY 2018-2019",
       caption = "In all estimates, asians are excluded from non-white or people of color categories.")
...
df_s275_dist %>% 
  ...
  labs(x =  "Average teacher experience (in years)",
       y = "",
       color = "Share of students of\ncolor in a district",
       title = "Density of average teacher experience across WA school districts in AY 2018-2019 by low to high shares of students of color",
       caption = "In all estimates, asians are excluded from non-white or people of color categories.")
...
df_s275_dist %>% 
  ...
  labs(x =  "Average teacher experience (in years)",
       y = "",
       color = "Share of students\nreceiving FRPL",
       title = "Density of average teacher experience across WA school districts in AY 2018-2019 by low to high shares of students poverty (measured by FRPL)",
       caption = "In all estimates, asians are excluded from non-white or people of color categories.")
...
df_s275_turnover <- df_s275 %>% 
  ...
  mutate(next_yr_coudis = dplyr::lead(coudis_s, order_by = schyear),
         ...
         tch_newcomer = if_else(is.na(dplyr::lag(cert, order_by = schyear)), 1, 0)) %>% 
  ungroup() %>% 
  group_by(coudis_s, schyear) %>% 
  mutate(dist_pctstu_nonwhite = mean(1 - replace_na(dis_pctstu_white, 0) - replace_na(dis_pctstu_asian, 0)),
            dist_pctstu_frpl = mean(replace_na(dis_pctstu_frl, 0)),
            dist_nonwhite_cat = if_else(dist_pctstu_nonwhite < 0.26, "0 to 25%",
                                        if_else(dist_pctstu_nonwhite >= 0.26 & dist_pctstu_nonwhite < 0.51, "26 to 50%",
                                                if_else(dist_pctstu_nonwhite >= 0.51 & dist_pctstu_nonwhite < 0.76, "51 to 75%",
...
# teacher turnover y students of color and poverty
df_s275_turnover %>% 
  filter(dist_nonwhite_cat %in% c("0 to 25%", "76 to 100%") & schyear < 2020) %>%
  ...
  labs(x = "",
       y = "turnover rate",
       color = "Share of students\nof color",
       title = "Average teacher turnover rate by high vs. low students of color in WA state between AY 2015-2016 to 2018-2019",
       caption = "In all estimates, asians are excluded from non-white or people of color categories.\nleavers are teachers who left the teaching profession or the system and movers are those who move to another district.")



df_s275_turnover %>% 
  filter(dist_poverty_cat %in% c("0 to 25%", "76 to 100%") & schyear < 2020) %>%
  ...
  labs(x = "",
       y = "turnover rate",
       color = "Share of students\nreceiving FRPL",
       title = "Average teacher turnover rate by high vs. low poverty in WA state between AY 2015-2016 to 2018-2019",
       caption = "In all estimates, asians are excluded from non-white or people of color categories.\nleavers are teachers who left the teaching profession or the system and movers are those who move to another district.")
...
# teacher newcomers
df_s275_turnover %>% 
  filter(dist_nonwhite_cat %in% c("0 to 25%", "76 to 100%") & schyear > 2016 & schyear < 2020) %>%
  group_by(schyear, dist_nonwhite_cat) %>% 
  summarize(tch_newcomer = mean(tch_newcomer == 1)) %>% 
...
labs(x = "",
     y = "newcomers rate",
     color = "Share of students\nof color",
     title = "Average teacher newcomers rate by high vs. low students of color in WA state between AY 2015-2016 to 2018-2019",
     caption = "In all estimates, asians are excluded from non-white or people of color categories.\nnewcomer is defined as a teacher who was not present in the system in the prior year.")


df_s275_turnover %>% 
  filter(dist_poverty_cat %in% c("0 to 25%", "76 to 100%") & schyear > 2016 & schyear < 2020) %>%
  group_by(schyear, dist_poverty_cat) %>% 
  summarize(tch_newcomer = mean(tch_newcomer == 1)) %>% 
  ...
  labs(x = "",
       y = "newcomers rate",
       color = "Share of students\nreceiving FRPL",
       title = "Average teacher newcomers rate by high vs. low poverty in WA state between AY 2015-2016 to 2018-2019",
       caption = "In all estimates, asians are excluded from non-white or people of color categories.\nnewcomer is defined as a teacher who was not present in the system in the prior year.")
