...
df_s275_dist <- df_s275 %>% 
  ...
  summarize(mean_dist_tch_black = mean(race == "B", na.rm = TRUE),
            ...
            mean_dist_tch_nonwhite1 = mean(race != "W", na.rm = TRUE),
            ...
            dist_pctstu_hisp = mean(replace_na(dis_pctstu_hispanic, 0)),
            ...
            dist_pctstu_nonwhite1 = mean(1 - replace_na(dis_pctstu_white, 0)),
