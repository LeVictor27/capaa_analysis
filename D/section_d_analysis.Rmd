...
```{r D.3 StrategicSupport student groups}

df_ss_stugroups <- df_LEA_plans %>%
  select("LEAName", "Grade", "StudentGroup", "StrategicSupports") 

df_ss_stugroups <- unique(df_ss_stugroups[c("LEAName", "Grade", "StudentGroup", "StrategicSupports")]) %>%
  mutate(StudentGroup = case_when(StudentGroup == "Two or more races" ~ "Two or more races students",
                                  StudentGroup == "Students of two or More Races" ~ "Two or more races students",
                                  TRUE ~ StudentGroup))
